...
function Start-Firefox {
    #Start Firefox with set tabs and pin them. 
...
{
    #Start Hyper-V, wait till VM heartbeat is detected.
    Start-VM -Name $vm
...
function Open-RDP
{
    #Open RDP and pass credentials. RDP file location, Host name (/v:), and credentials would need to be replaced
